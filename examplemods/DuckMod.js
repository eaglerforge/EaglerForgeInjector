(function DuckEntity() {
    ...
    function registerEntity() {
        ...
        var nme_EntityDuck = function nme_EntityDuck($worldIn) {
            ...
            this.$tasks.$addTask(0, AITask("EntityAISwimming", 1)(this));
            this.$tasks.$addTask(1, AITask("EntityAIPanic", 2)(this, 1.9));
            this.$tasks.$addTask(2, AITask("EntityAIMate", 2)(this, 1.0));
            this.$tasks.$addTask(3, AITask("EntityAITempt", 4)(this, 1.5, ModAPI.items.bread.getRef(), 0)); //won't cause a problem as the bread is obtained when the entity is constructed.
            this.$tasks.$addTask(4, AITask("EntityAIFollowParent", 2)(this, 1.2));
            this.$tasks.$addTask(5, AITask("EntityAIWander", 2)(this, 1.1));
            this.$tasks.$addTask(6, AITask("EntityAIWatchClosest", 3)(this, ModAPI.util.asClass(EntityPlayer.class), 6));
            this.$tasks.$addTask(7, AITask("EntityAILookIdle", 1)(this));
        }
        ...
        nme_EntityDuck.prototype.$playStepSound = function () {
            this.$playSound("mob.duck.step", 0.2, 1);
        }
        ...
        nme_EntityDuck.prototype.$createChild = function (otherParent) {
            return new nme_EntityDuck(this.$worldObj);
        }
    ...
    ModAPI.addEventListener("lib:asyncsink", async () => {
        ...
        AsyncSink.Audio.register("mob.duck.quack", AsyncSink.Audio.Category.ANIMAL, [
            {
        ...
        AsyncSink.Audio.register("mob.duck.step", AsyncSink.Audio.Category.ANIMAL, [
            {
