...
async function main() {
    ...
    if (args.includes("help") || args.length === 0) {
        ...
        console.log("> npx efi init #Copies the template files");
        return;
    }
    ...
    if (!inputFile) {
        ...
        console.log("***************************");
        console.log("");
        console.log("No file provided! Please provide a file to patch.");
        console.log("Use 'npx efi help' for more information.");
        return;
    }
